...
//pitch �ٶȻ� PID�����Լ� PID���������������
#define PITCH_SPEED_PID_KP        4000.0f//ԭʼ��ֵ10000.0f
#define PITCH_SPEED_PID_KI        50.0f//ԭʼ��ֵ60.0f
#define PITCH_SPEED_PID_KD        0.0f//ԭʼ��ֵ0.0f
#define PITCH_SPEED_PID_MAX_OUT   30100.0f//ԭʼ��ֵ30000.0f
#define PITCH_SPEED_PID_MAX_IOUT  10000.0f//ԭʼ��ֵ10000.0f

//yaw speed close-loop PID params, max out and max iout	��
//yaw �ٶȻ� PID�����Լ� PID���������������
#define YAW_SPEED_PID_KP        8200.0f//ԭʼֵ3600.0f
#define YAW_SPEED_PID_KI        15.0f//ԭʼֵ20.0f
#define YAW_SPEED_PID_KD        0.0f//ԭʼֵ0.0f
#define YAW_SPEED_PID_MAX_OUT   30000.0f//ԭʼֵ30000.0f
#define YAW_SPEED_PID_MAX_IOUT  5000.0f//ԭʼֵ5000.0f

//pitch gyro angle close-loop PID params, max out and max iout
//pitch �ǶȻ� �Ƕ��������ǽ��� PID�����Լ� PID���������������
#define PITCH_GYRO_ABSOLUTE_PID_KP 15.0f//ԭʼ��ֵ 15.0f
#define PITCH_GYRO_ABSOLUTE_PID_KI 0.0f//ԭʼ��ֵ0.	0f
#define PITCH_GYRO_ABSOLUTE_PID_KD 0.0f//ԭʼ��ֵ0.0f
...
#define YAW_GYRO_ABSOLUTE_PID_KP        16.0f//ԭʼ��ֵ 26.0f
#define YAW_GYRO_ABSOLUTE_PID_KI        0.0f//ԭʼֵ0.0f
#define YAW_GYRO_ABSOLUTE_PID_KD        0.3f//ԭʼֵ0.3f
#define YAW_GYRO_ABSOLUTE_PID_MAX_OUT   10.0f//ԭʼֵ10.0f
#define YAW_GYRO_ABSOLUTE_PID_MAX_IOUT  0.0f//ԭʼֵ0.0f

//pitch encode angle close-loop PID params, max out and max iout
//pitch �ǶȻ� �Ƕ��ɱ����� PID�����Լ� PID���������������
#define PITCH_ENCODE_RELATIVE_PID_KP 15.0f//ԭʼֵ15
#define PITCH_ENCODE_RELATIVE_PID_KI 0.0f//0.1
#define PITCH_ENCODE_RELATIVE_PID_KD 0.0f//0.01
...
#define YAW_OFFSET_ECD_FORWARD			483
#define YAW_OFFSET_ECD_BACKWARD			4597
//turn 180��
//��ͷ180 ����
...
typedef enum
{
	GIMBAL_YAW_FORWARD,
	GIMBAL_YAW_BACKWARD,
} gimbal_yaw_direction_e;  // yaw��̨��ǰ�����
...
//		pid_type_def CV_x_pid;
//		pid_type_def CV_y_pid;
		/********************************/
} gimbal_control_t;
