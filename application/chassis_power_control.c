...
/**
  ...
  */
	...
	float POWER_LIMIT;
 float WARNING_POWER;
 uint16_t WARNING_POWER_BUFF;
 void chassis_grade()
 {
// if(robot_status.robot_level==1)//55
// {
//  POWER_LIMIT=60;
//  WARNING_POWER=0.5*POWER_LIMIT;
//  WARNING_POWER_BUFF=0.625*POWER_LIMIT;
// }
// else if(robot_status.robot_level==2)//60
// {
//  POWER_LIMIT=80;
//  WARNING_POWER=0.5*POWER_LIMIT;
//  WARNING_POWER_BUFF=0.625*POWER_LIMIT;
// }
// else if(robot_status.robot_level==3)//65
// {
//  POWER_LIMIT=100;
//  WARNING_POWER=0.5*POWER_LIMIT;
//  WARNING_POWER_BUFF=0.625*POWER_LIMIT;
// }
  ...
  WARNING_POWER=0.5*POWER_LIMIT;
  WARNING_POWER_BUFF=60;//0.625*POWER_LIMIT;
 }
    ...
    else
    {
        ...
        if(chassis_power_buffer < WARNING_POWER_BUFF)
        {
            ...
            else
            {
                ...
                power_scale = 0.6 / WARNING_POWER_BUFF;
            }
//						power_scale=0.0f;
            //scale down
            //缩小
