...
//前后的遥控器通道号码
#define CHASSIS_X_CHANNEL 1//0
//the channel num of controlling horizontal speed
//左右的遥控器通道号码
#define CHASSIS_Y_CHANNEL 0//1
...
//遥控器前进摇杆（max 660）转化成车体前进速度（m/s）的比例0.006f
#define CHASSIS_VX_RC_SEN 0.006f
//裁判系统下前进摇杆（max 660）转化成车体前进速度（m/s）的比例0.006f
#define CHASSIS_REFEREE_VX_RC_SEN 0.006f
//rocker value (max 660) change to horizontal speed (m/s)
//遥控器左右摇杆（max 660）转化成车体左右速度（m/s）的比例
#define CHASSIS_REFEREE_VY_RC_SEN 0.005f//裁判系统
...
#define CHASSIS_REFEREE_RC_DEADLINE 10
...
#define HERO 0
#define INFANTRY 1
#define MILITARY_UNIT HERO

#define R_OF_WHEEL 0.1f
#define R_OF_INFANTRY 0.5f
...
#define CHASSIS_LEFT_KEY KEY_PRESSED_OFFSET_A//A
#define CHASSIS_RIGHT_KEY KEY_PRESSED_OFFSET_D//D
...
//底盘运动过程最大平移速度
#define NORMAL_MAX_CHASSIS_SPEED_Y 8.0f//0.5
//2级 3.0
//3级 5.0
//1级 2.0
//底盘键盘操作斜波函数增量
#define RAMP_KEY_ADD_VX 0.06f
#define RAMP_KEY_ADD_VY 0.06f
...
//底盘电机速度环PID
#define M3505_MOTOR_SPEED_PID_KP 7000.0f//原数值15000.0f
#define M3505_MOTOR_SPEED_PID_KI 0.0f//原数值10.0f
#define M3505_MOTOR_SPEED_PID_KD 1.0f
#define M3505_MOTOR_SPEED_PID_MAX_OUT MAX_MOTOR_CAN_CURRENT
#define M3505_MOTOR_SPEED_PID_MAX_IOUT 2100.0f//2000.0f

//chassis follow angle PID
//底盘旋转跟随PID
#define CHASSIS_FOLLOW_GIMBAL_PID_KP 58.0f//40.0f,53
#define CHASSIS_FOLLOW_GIMBAL_PID_KI 0.0f//0.0
#define CHASSIS_FOLLOW_GIMBAL_PID_KD 8.0f//0.0
#define CHASSIS_FOLLOW_GIMBAL_PID_MAX_OUT 8.0f
#define CHASSIS_FOLLOW_GIMBAL_PID_MAX_IOUT 0.2f

#define LENGTH_L 545
#define LENGTH_A 193//底盘长的一半
#define LENGTH_B 193//底盘宽的一半
...
//  CHASSIS_VECTOR_NO_FOLLOW_YAW,       //chassis will have rotation speed control. 底盘有旋转速度控制
  CHASSIS_VECTOR_RAW,                 //control-current will be sent to CAN bus derectly.
	CHASSIS_VECTOR_FOLLOW_GIMBAL_YAW_SPIN
} chassis_mode_e;
...
typedef struct
{
  ...
  const fp32 *chassis_INS_angle; 	//the point to the euler angle of gyro sensor.获取陀螺仪解算出的欧拉角指针
	ext_robot_command_t ext_robot_command;     //裁判系统替换指针
  ...
  pid_type_def chassis_angle_pid;              //follow angle PID.底盘跟随角度pid
	...
	pid_type_def chassis_no_follow_angle_pid;  
